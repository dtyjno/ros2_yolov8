...
#include "ros2_yolo_msgs/msg/detail/detected_box__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_yolo_msgs::msg::DetectedBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_yolo_msgs::msg::DetectedBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_yolo_msgs::msg::DetectedBox *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectedBox__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros2_yolo_msgs::msg::DetectedBox *>(
...
static size_t _DetectedBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectedBox(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DetectedBox__callbacks = {
  "ros2_yolo_msgs::msg",
  "DetectedBox",
...
static rosidl_message_type_support_t _DetectedBox__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectedBox__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ros2_yolo_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<ros2_yolo_msgs::msg::DetectedBox>()
{
  return &ros2_yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectedBox__handle;
}
