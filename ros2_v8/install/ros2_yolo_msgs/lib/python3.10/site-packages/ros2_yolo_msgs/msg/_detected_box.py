...
class Metaclass_DetectedBox(type):
    """Metaclass of message 'DetectedBox'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ros2_yolo_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ros2_yolo_msgs.msg.DetectedBox')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__detected_box
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__detected_box
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__detected_box
            cls._TYPE_SUPPORT = module.type_support_msg__msg__detected_box
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__detected_box
...
class DetectedBox(metaclass=Metaclass_DetectedBox):
    """Message class 'DetectedBox'."""
    ...
    def servo(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'servo' field must be an integer in [-2147483648, 2147483647]"
        self._servo = value
