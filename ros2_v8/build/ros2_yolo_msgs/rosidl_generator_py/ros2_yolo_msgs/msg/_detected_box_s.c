...
bool ros2_yolo_msgs__msg__detected_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_yolo_msgs.msg._detected_box.DetectedBox", full_classname_dest, 44) == 0);
  }
  ros2_yolo_msgs__msg__DetectedBox * ros_message = _ros_message;
  {  // x1
  ...
  {  // servo
    ...
    ros_message->servo = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of DetectedBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_yolo_msgs.msg._detected_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DetectedBox");
